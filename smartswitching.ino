...
const char* ssid = "Narasimha";         
const char* password = "narasimha";     

const char* scriptUrl = "https://script.google.com/macros/s/AKfycbxLW3nBqMJsv2aUBjAOPBnMdryM93eiODGQoi6m7g_l_aREv4vbPWpqQ6Gc1wphijdecQ/exec";  // Replace with your Google Apps Script URL
const char* GOOGLE_SCRIPT_ID = "AKfycbxLW3nBqMJsv2aUBjAOPBnMdryM93eiODGQoi6m7g_l_aREv4vbPWpqQ6Gc1wphijdecQ";
